...
["Chess mastery essentially consists of analyzing.", "Mikhail Botvinnik"],
[
...
["Chess isn’t a game of speed, it is a game of speech through actions.", "Matthew Selman"],
["Life like chess is about knowing to do the right move at the right time.", "Kaleb Rivera"],
["Come on Harry!", "Simon Williams"],
[
...
["On the bright side, I no longer have any more pieces to lose.", "John ~ZugAddict~ Chernoff"],
[
...
["Never play for the win, never play for the draw, just play chess!", "Khalifman"],
[
...
["All conceptions in the game of chess have a geometrical basis.", "Eugene Znosko-Borowski"],
[
...
["Black's d5-square is too weak.", "Ulf Andersson  [on the Dragon variation]"],
...
["Watch out for the tricky knights.", "ChessNetwork"],
...
["Be well enough prepared that preparation won't play a role.", "Magnus Carlsen"],
...
["You'll be amazed at the people I've lost to while playing online.", "Magnus Carlsen"],
[
...
["Fortune favors the lucky!", "Robert Houdart [Houdini author]"],
["I don't berserk, I am not a caveman", "Magnus Carlsen"],
[
...
["Chess as a game is too serious; as a serious pursuit too frivolous.", "Moses Mendelssohn"],
["Chess makes me a better person", "Albert Badosa"],
    // lichess facts
["All features for free; for everyone; forever.", "lichess.org"],
["We will never display ads.", "lichess.org"],
["We do not track you. It's a rare feature, nowadays.", "lichess.org"],
["Every chess player is a premium user.", "lichess.org"],
